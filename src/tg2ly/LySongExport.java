...
public class LySongExport {
	...
	public LySongExport(OutputStream stream,LilypondSettings settings){
...
//		}
	...
	public String getLilypondTuning(TGTrack track){
//		String tuning = ("\\with { stringTunings = #`( ");
		String tuning = "\\set TabStaff.stringTunings = #`( ";
